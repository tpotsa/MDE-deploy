...
output "mde_deployment_subnetwork_project_id" {
  value = google_compute_subnetwork.mde_data_lake_subnet.network
}

output "mde_deployment_subnetwork_name" {
  value = google_compute_subnetwork.mde_data_lake_subnet.name
}

output "mde_deployment_subnetwork_self_link" {
  value = google_compute_subnetwork.mde_data_lake_subnet.self_link
}
